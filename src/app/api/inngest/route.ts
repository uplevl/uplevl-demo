...
import generateFinalVideo from "@/inngest/functions/generate-final-video";
...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [parseZillowProperty, generateScripts, generateAutoReel, generateFinalVideo],
});
